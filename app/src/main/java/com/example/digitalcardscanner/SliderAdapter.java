...
public class SliderAdapter extends PagerAdapter {
    ...
    int images[] = {
            R.drawable.scanbusinesscard3,
            R.drawable.cardscanner,
            R.drawable.ewallet,
            R.drawable.chats,
            R.drawable.createcard,
            R.drawable.importcontacts,
            R.drawable.scanqr,
            R.drawable.sitbackandenjoy
    };
