...
import com.example.digitalcardscanner.ScanActivity;
...
public class MainActivitytransfer extends AppCompatActivity {
   ...
   String[] values;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button1.setOnClickListener(v -> {
            Intent intent=new Intent(MainActivitytransfer.this, ScanActivity.class);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivitytransfer.this,AllContacts.class);
                startActivity(intent);
            }
        });
       ...
       //Log.d("hello",result.getContents().toString());
        ...
        if(result !=null){
            if(result.getContents() == null){
                ...
                values= new ArrayList<String>().toArray(new String[0]);
                values=result.getContents().toString().split("");
               // values= result.getContents().toString().split("//");
                if(mydb.insertContact(values[0],
                        values[1],
                        values[2],
                        values[3],
                        values[4]))
