...
import com.example.digitalcardscanner.databinding.ActivityMainchatsBinding;
...
public class MainActivityChats extends AppCompatActivity {

    ActivityMainchatsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMainchatsBinding.inflate(getLayoutInflater());
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(new OnSuccessListener<Boolean>() {
            ...
            public void onSuccess(Boolean aBoolean) {
                ...
                Glide.with(MainActivityChats.this)
...
//        binding.recyclerView.setLayoutManager(new LinearLayoutManager(this));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.group:
                startActivity(new Intent(MainActivityChats.this, GroupChatActivity.class));
                break;
            case R.id.search:
