...
public class GroupChatActivity extends AppCompatActivity {
    ...
    com.example.digitalcardscanner.databinding.ActivityGroupChatBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.example.digitalcardscanner.databinding.ActivityGroupChatBinding.inflate(getLayoutInflater());
